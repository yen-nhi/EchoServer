...
from tests.common_test import Server, test_multi_client_connection, test_single_client_connection

MAIN_FILE = '../server/single_thread_select.py'

class TestSingleThreadSelect(unittest.TestCase):

    def test_single_thread_select_single_client(self):
    ...
    def test_single_thread_select_multi_connection(self):
        with Server(MAIN_FILE):
